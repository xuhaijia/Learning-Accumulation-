...
/**
 * Created by xuhaijia on 2017/5/5.
 */
public class MyRatioImageView extends ImageView {
    //宽高比，由我们自己设定
    private float ratio;
    public MyRatioImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        //获得属性名称和对应的值
...
//        }
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MyRatioImageView);
        //根据属性名称获取对应的值，属性名称的格式为类名_属性名
        ratio = typedArray.getFloat(R.styleable.MyRatioImageView_ratio, 0.0f);
